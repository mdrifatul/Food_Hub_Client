  ...
  return (
    <div className="min-h-screen bg-zinc-50/50 dark:bg-zinc-950/20 relative pb-20 overflow-hidden pt-8">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-6">
        ...
        {!orderList || orderList.length === 0 ? (
          <div className="text-center py-24 bg-white/70 dark:bg-zinc-900/40 backdrop-blur-xl rounded-3xl border border-zinc-200/50 dark:border-zinc-800/50 shadow-xl max-w-3xl mx-auto">
